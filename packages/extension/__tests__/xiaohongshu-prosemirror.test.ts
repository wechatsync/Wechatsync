...
describe('markdownToXiaohongshuProseMirror', () => {
  it('converts paragraphs without leaving raw line breaks in text nodes', () => {
    const result = markdownToXiaohongshuProseMirror(
      '第一行\n第二行\n\n第三段',
      new Map()
    )
  ...
  it('matches Xiaohongshu heading, marks, list and image node names', () => {
